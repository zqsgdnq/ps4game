...
PS4Mesh* PS4Mesh::GenerateQuad() {
	...
	mesh->SetPrimitiveType(NCL::GeometryPrimitive::TriangleStrip);
...
sce::Gnm::PrimitiveType GetGNMType(NCL::GeometryPrimitive type) {
	switch (type) {
		case NCL::GeometryPrimitive::Points:		return sce::Gnm::PrimitiveType::kPrimitiveTypePointList;
		case NCL::GeometryPrimitive::Lines:			return sce::Gnm::PrimitiveType::kPrimitiveTypeLineList;
		case NCL::GeometryPrimitive::Triangles:		return sce::Gnm::PrimitiveType::kPrimitiveTypeTriList;
		case NCL::GeometryPrimitive::TriangleStrip: return sce::Gnm::PrimitiveType::kPrimitiveTypeTriStrip;
		case NCL::GeometryPrimitive::TriangleFan:	return sce::Gnm::PrimitiveType::kPrimitiveTypeTriFan;
		case NCL::GeometryPrimitive::Patches:		return sce::Gnm::PrimitiveType::kPrimitiveTypePatch;
	}
}
...
void PS4Mesh::SubmitDraw(Gnmx::GnmxGfxContext& cmdList, Gnm::ShaderStage stage) {
	...
	cmdList.setPrimitiveType(GetGNMType(primType));
